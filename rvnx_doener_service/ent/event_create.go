...
func (ec *EventCreate) SetInfo(m map[string]interface{}) *EventCreate {
...
func (ec *EventCreate) check() error {
	...
	if _, ok := ec.mutation.Info(); !ok {
		return &ValidationError{Name: "info", err: errors.New(`ent: missing required field "Event.info"`)}
	}
	return nil
}
